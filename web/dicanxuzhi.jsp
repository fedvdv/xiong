            ...
            <div class="row row-narrow">
                <div class="page-sidebar">
                    <div class="sidebar-menu">
                        ...
                        <ul class="menu">
                            <div remove="tag">
                                <!-- <th:block if="${#strings.isEmpty(staticLink.urlLink) or staticLink.urlLink == null}"> -->


                                <!-- </th:block> -->


                                <li class="menu-item"><a class="menu-item-target" href="wanzhantiaokuan.jsp" target="_self">网站条款</a></li>
                            ...
                            <div remove="tag">
                                ...
                                <li class="menu-item"><a class="menu-item-target" href="yisitiaokuan.jsp" target="_self">隐私政策</a></li>
                            ...
                            <div remove="tag">
                                ...
                                <li class="menu-item selected"><a class="menu-item-target" href="dicanxuzhi.jsp">订餐须知</a></li>
                            ...
                            <div remove="tag">
                                ...
                                <li class="menu-item"><a class="menu-item-target" href="question.jsp" target="_self">常见问题</a></li>
                            ...
                            <div remove="tag">
                                ...
                                <li class="menu-item"><a class="menu-item-target" href="30fen.jsp">关于30分钟必达</a></li>
                            ...
                            <div remove="tag">
                                ...
                                <li class="menu-item"><a class="menu-item-target" href="phone.jsp" target="_self">手机网站</a></li>
                    ...
                    <div class="panel-lg panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h3></h3><h3>关于麦乐送</h3>
                                    <p></p><p>麦当劳麦乐送是驰名的美食外送专家，属于全球著名的快餐品牌—麦当劳。</p><p></p>
                                    <p></p><p>麦当劳麦乐送实行专有的菜单及定价，提供各式汉堡以及小食、甜点、饮品等餐饮。麦当劳麦乐送不设餐厅堂食，如需堂食，请到麦当劳各门店餐厅享用。专业的外送员工队伍，便捷的交通工具、特别设计的外送包、 让您轻轻松松就能在家中尽情享受美味！</p><p></p>
                                    <h3></h3><h3>订餐须知</h3>
                                    <p></p><p>欢迎使用麦乐送网上订餐服务。请您在订餐前详细阅读并了解以下麦乐送网上订餐须知。麦当劳可能在法律允许的范围内对本须知的内容不时进行适当调整，敬请留意本网站的更新内容。</p><p></p>
                                    <p></p><ul><li>目前开通网上订餐的城市为上海、北京、天津、广州、深圳、佛山、东莞、中山、汕头、惠州、沈阳、大连、杭州、宁波、南京、武汉、西安、成都、福州、厦门、泉州、晋江、石狮。为保证产品质量，各麦乐送餐厅送餐范围有限，若您的送餐地址超出服务区造成无法送餐，敬请谅解。</li><p></p>
                                    <ul><li></li><li>麦乐送全天24小时可接受网上订餐，并可接受1小时以上7天内预约订餐。订餐可选择的产品以订餐时网上确认的为准。早餐供应时间为上午5:00至上午10:30，每天上午10:15后不接受当天的早餐预定。</li>
                                        <li></li><li>网上订餐不设最低消费。每单外送订餐，均收取人民币8元送餐费，谢绝小费。如果您的订餐金额大于300（含300）元人民币，请致电4008-517-517寻求帮助或重新订餐。</li>
                                        <li></li><li>麦乐送网上菜单及价格在不同城市、不同麦乐送餐厅可能存在差异，部分产品仅在特定的餐厅供应。麦乐送可能不预先通知而不时对网上菜单进行调整。产品和包装以实物为准。</li>
                                        <li></li><li>开心乐园餐玩具供应款式以餐厅实际供应为准。</li>
                                        <li></li><li>网上订餐可享受的优惠项目应统一以麦乐送网站列出的优惠项目为准且不得与麦当劳餐厅提供的其他优惠项目同时使用，您的点餐内容或数量都有可能会影响您实际享受到的优惠。</li>
                                        <li></li><li>网上订餐可享受的优惠项目应统一以麦乐送网站列出的优惠项目为准且不得与麦当劳餐厅提供的其他优惠项目同时使用，您的点餐内容或数量都有可能会影响您实际享受到的优惠。</li>
                                        <li></li><li>网上订餐可享受的优惠项目应统一以麦乐送网站列出的优惠项目为准且不得与麦当劳餐厅提供的其他优惠项目同时使用，您的点餐内容或数量都有可能会影响您实际享受到的优惠。</li>
                                        <li></li><li>网上订餐可享受的优惠项目应统一以麦乐送网站列出的优惠项目为准且不得与麦当劳餐厅提供的其他优惠项目同时使用，您的点餐内容或数量都有可能会影响您实际享受到的优惠。</li>
                                        <li></li><li>网上订餐可享受的优惠项目应统一以麦乐送网站列出的优惠项目为准且不得与麦当劳餐厅提供的其他优惠项目同时使用，您的点餐内容或数量都有可能会影响您实际享受到的优惠。</li>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-offset-3 col-xs-6">
                        <form action="#" method="post" accept-charset="utf-8" role="form" id="form_login_modal" name="form_login_modal" class="form-login-modal form-login" data-required-symbol="false" novalidate>
